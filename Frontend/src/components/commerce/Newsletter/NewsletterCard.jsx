...
export default function NewsletterCard({ item, className = "" }) {
  return (
    <div
      className={`w-full max-w-4xl mx-auto bg-[var(--color-card-bg)] border border-[var(--color-card-border)] rounded-[var(--radius-xl)] p-6 sm:p-8 md:p-12 shadow-[var(--shadow-sm)] hover:shadow-[var(--shadow-md)] transition-all flex flex-col gap-8 ${className}`}
    >
